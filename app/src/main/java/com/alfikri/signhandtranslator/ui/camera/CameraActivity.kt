package com.alfikri.signhandtranslator.ui.camera
...
import com.alfikri.signhandtranslator.databinding.ActivityCameraBinding
import com.alfikri.signhandtranslator.ml.Model
import com.alfikri.signhandtranslator.utils.BitmapOutputAnalysis
import com.alfikri.signhandtranslator.utils.SIGN_TRANSLATOR
...
import org.tensorflow.lite.support.model.Model as Model1
...
class CameraActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!allPermissionGranted){
            ...
            val options: Model1.Options = Model1.Options.Builder().setDevice(Model1.Device.GPU).setNumThreads(5).build()
    ...
    private fun setCameraUseCase(){
        ...
        try {
            ...
            Log.e(SIGN_TRANSLATOR, "Camera binding failure", e)
        }
    }
    ...
    private fun setCameraController(){
        ...
        try {
            ...
            Log.e(SIGN_TRANSLATOR, "Camera failure : ", e)
        }
    }
